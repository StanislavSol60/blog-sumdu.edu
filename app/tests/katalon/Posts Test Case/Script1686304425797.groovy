...
WebUI.setText(findTestObject('Object Repository/Page_Flask Blog/input_Sign Up_email'), 'test.posts@gmail.com')
...
WebUI.doubleClick(findTestObject('Object Repository/Page_Flask Blog/input_Sign Up_name'))

WebUI.setText(findTestObject('Object Repository/Page_Flask Blog/input_Sign Up_name'), 'test posts')
...
WebUI.setText(findTestObject('Object Repository/Page_Flask Blog/input_Congratulations, you are now a regist_b591c9'), 'test.posts@gmail.com')
...
WebUI.setText(findTestObject('Object Repository/Page_Flask Blog/input_Title_title'), 'new test post')

WebUI.setText(findTestObject('Page_Flask Blog/textarea_Content_content'), 'new test post content')

WebUI.click(findTestObject('Object Repository/Page_Flask Blog/button_Submit'))

WebUI.click(findTestObject('Object Repository/Page_Flask Blog/a_Edit'))

WebUI.setText(findTestObject('Object Repository/Page_Flask Blog/input_Title_title'), 'test post')

WebUI.click(findTestObject('Object Repository/Page_Flask Blog/input_Title_title'))

WebUI.setText(findTestObject('Object Repository/Page_Flask Blog/textarea_new test post content'), 'test post content')

WebUI.click(findTestObject('Object Repository/Page_Flask Blog/button_Update Post'))

WebUI.click(findTestObject('Object Repository/Page_Flask Blog/a_Delete'))
